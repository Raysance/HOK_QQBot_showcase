...
- [GloryBond (QQ-HOK-Agent) 使用手册](#glorybond-qq-hok-agent-使用手册)
  - [目录](#目录)
  - [🎯 功能速查](#-功能速查)
  - [📖 总览](#-总览)
  - [🎮 核心功能](#-核心功能)
...
**功能说明**：
- **深度胜率报告**：分析指定群友组成的固定车队（2~5人）的历史同局数据。
- **兼容性评估**：评估该车队的整体胜率、各位置重叠度、共同擅长的战术体系，并指出该团队的"短板"与"最强套路"。
- **阵容推荐**：基于参与者的历史绝活英雄，推荐一套最容易上分的五排/多排阵容组合。

```
⚔️ [开黑车队全维度评估]
车队构成： @龙牙之圣剑、@云上之缨、@o.O__O.o、@小番茄玩中单、@zhdxlz
近期胜率： 58% (近 10 场 6 胜 4 负)

多维指标画像：

阵容平衡度： 偏向后期发育。全队平均场均时长 18.5min。

核心大腿： @zhdxlz (近 3 场 MVP 率 60%)。当该成员拿到经济优势时，车队胜率提升至 80%。
```
---
...
#### 4. 自动播报
**自动功能**：无需触发 (游戏结束后自动评估并播报)

**功能说明**：
- **高光对局播报**：当检测到群成员打出极其优异的高光表现（如超高评分、超鬼战绩等）时，自动在群内播报庆祝。
- **连胜连败播报**：自动追踪玩家状态，当达成多连胜（如3连胜、5连败）或遭遇多连败时，触发群内特殊播报互动，活跃群氛围。

```
📣 全群通告！
刚刚 @散场预告 在一场对局中打出了 [五连绝世]！
英雄：[女娲]
K/D/A：[9/0/11] 评分 15.6
评价：这波操作简直是职业选手附体！这哪是打游戏，这是在拍电影啊！建议群友全员起立敬礼！🫡
https://zhdxlz.top/btlperson?key=c52896b414888220
```
<img src="assets/autocast_btl.png" width="300" alt="单人战绩-Web图片">
---

#### 5. 智能缺人摇人
**触发方式**：群内出现包含“缺人”、“差一”、“等位”等组队相关关键词的消息。

**功能说明**：
- **智能分析匹配**：机器人会自动分析当前发车队伍的模式与可能的段位需求，并智能查询群内段位符合条件且近期活跃的玩家。
- **自动摇人艾特**：自动@那些符合条件大概率能玩的群成员，省去手动摇人的麻烦，大幅提高组队效率。

```
@云上之缨 缺个核心打野，速来。
阵容诊断： 观察到这队选人偏向后期发力，前期抗压能力弱。你作为本群省级云缨，压制力正是这队需要的。
胜率预测： 结合你与当前队友的历史组队数据，你们的胜率期望高达 68%。别犹豫了，上车即发车。
```
---
